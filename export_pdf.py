...
def export_to_pdf(json_data):
    ...
    # 1. Personal Info
    elements.append(Paragraph("Credit Report Analytics", title_style))
    elements.append(Spacer(6, 12))
    personal_info = data[0].get("Personal Information")
