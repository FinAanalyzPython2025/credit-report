...
json_data = r'D:\LiteFin\12_LOS\credit report\joshykg-credit-report.json'  # Replace with your actual file path
with open(json_data, 'r') as file:
            data = json.load(file)

result = extract_enquiry_data(data)
result1 = basic_details(data)
print(result)
print(result1)
# print("Extracted Enquiries:\n", result)