...
def loan_appraisal_scorecard(data):
    ...
    try:
        ...
        def calculate_enquiry_score(enquiries, weightage=10):
            unsecured_types = ['PERSONAL LOAN', 'CREDIT CARD', 'EDUCATIONAL LOAN']
            unsecured_count = sum(1 for e in enquiries if e['Purpose'] in unsecured_types)
        ...
        enquiry_frequency = calculate_enquiry_score(enquiries_dict, weightage=10)
        scorecard['Enquiry Frequency'] = enquiry_frequency
        ...
        return jsonify({"error": "Error processing loan appraisal scorecard : " ,"Error": str(e)}), 500
